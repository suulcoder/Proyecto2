...
/*
***
Muchas funciones dentro del código fueron extraídas de:
...
/*
***
Hacemos la validación de la llave
Se llama a la funcion _decipher para intentar descifrar el mensaje con los datos provistos
***
*/
...
int main(int argc, char* argv[]) {
  ...
  string read_line;
   ...
   //definimos input stream con nombre de archivo ingresado
  ...
  else
  {
    ...
    ***
    Ciframos el archivo 
    El texto debe cazar con el tamaño del bloque
    ***
    */
    try
    {
